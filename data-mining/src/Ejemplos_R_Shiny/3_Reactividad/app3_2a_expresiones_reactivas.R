# ====================================================
# Ejemplo 2 de reactividad (sin expresiones reactivas)
# ====================================================
...
server <- function(input, output, session) {
  output$histog <- renderPlot({
    # Valores del dataset 1 y 2
    x1 <- rnorm(input$n1, input$media1, input$desv1)
    x2 <- rnorm(input$n2, input$media2, input$desv2)
    # Gráfico
